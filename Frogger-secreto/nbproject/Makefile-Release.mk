...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/frogger-secreto
...
${OBJECTDIR}/_ext/3bc3e000/eventQueue.o: ../../../Desktop/progra/TPF/eventQueue/eventQueue.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/3bc3e000/eventQueue.o ../../../Desktop/progra/TPF/eventQueue/eventQueue.c
...
${OBJECTDIR}/modulorpi.o: modulorpi.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/modulorpi.o modulorpi.c

${OBJECTDIR}/timer_threads.o: timer_threads.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/timer_threads.o timer_threads.c
